...
const Formulario = ({ pacientes, setPacientes, paciente }) => {
    ...
    return (
        <div className="px-2 mt-4 md:w-1/2 lg:w-2/5">
            <h2 className="font-bold text-2xl text-center">Seguimiento Pacientes</h2>

            <p className="text-lg mt-2 text-center mb-6">
                Añade Pacientes y {''}
                <span className="text-pink-600 font-bold">Adminístrarlos</span>
            </p>

            <form
                onSubmit={handleSubmit}
                className="bg-white shadow-md rounded-md py-4 px-5"
            >
                ...
                <input
                    type="submit"
                    className="bg-pink-600 w-full p-3 mb-3 text-white uppercase font-bold rounded-md hover:bg-pink-900 cursor-pointer transition-colors"
